...
import QuickSetupView from './views/QuickSetupView.vue'
import { useRuntime } from './composables/useRuntime'

type ViewName = 'quick' | 'overview' | 'proxies' | 'connections' | 'rules' | 'settings' | 'logs'

const validViews: ViewName[] = ['quick', 'overview', 'proxies', 'connections', 'rules', 'settings', 'logs']
const initial = window.location.hash.replace(/^#\/?/, '') as ViewName
const activeView = ref<ViewName>(validViews.includes(initial) ? initial : 'quick')
  ...
  <div class="app-shell">
    ...
    <div class="app-workspace">
      ...
      <main class="app-content" :aria-busy="runtime.loading.value">
        <QuickSetupView v-if="activeView === 'quick'" />
        <OverviewView
